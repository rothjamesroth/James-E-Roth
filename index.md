...
<div style="position: relative;">
  <img src="images/pe-stamp.png" alt="Professional Engineer Stamp" style="position: absolute; top: 20px; right: 20px; width: 190px; height: auto;">
</div>
...
## Contact
<!-- Contact Section -->
<section id="contact" style="padding: 60px 20px; background-color: #f8f8f8;">
  <h2 style="text-align: center; font-size: 2em; margin-bottom: 20px;">Contact Me</h2>
